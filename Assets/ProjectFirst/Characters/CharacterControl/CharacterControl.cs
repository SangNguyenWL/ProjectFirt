...
namespace projectfirst
{
    ...
    public class CharacterControl : MonoBehaviour
    {
        ...
        {
            if(!CharacterManager.Instance.Character.Contains(this))
            {
                CharacterManager.Instance.Character.Add(this);
            }
        }
        ...
        {
            if(UnityEngine.SceneManagement.SceneManager.GetActiveScene().name.Equals(RBScenes.SelectCharacter.ToString()))
            {
                return;
            }
